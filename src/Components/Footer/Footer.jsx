...
function Footer() {
  return (
    ...
    <div  className='w-[90vw] mx-auto border-t border-[var(--color-lightblack)] py-10 max-sm:w-[100vw]'>
        <div className='max-sm:flex max-sm:justify-center '>
            <img className="w-[10vw] max-sm:w-[50vw] rounded-full" src="img/logo.jpg" alt="" />
        </div>

        <div className='grid grid-cols-4 max-sm:grid-cols-1 max-sm:gap-5'>
            <div className='items-center max-sm:flex max-sm:flex-col max-sm:justify-center'>
            ...
            <div className='items-center max-sm:flex max-sm:flex-col max-sm:justify-center'>
                ...
                <div className='flex gap-2 mt-5 mb-5 max-sm:items-center'>

                    <img className='w-[2vw] max-sm:w-[10vw]' src="img/facebook.png" alt="" />
                ...
                <div className='flex w-[2vw] max-sm:w-[10vw] max-sm:justify-center gap-2'>
            ...
            <div>
                <h1 className='text-2xl font-extrabold mb-5 max-sm:text-center'>KEEP UP TO DATE</h1>
                ...
                <div className='mt-5'>
                <iframe className='max-sm:w-[98vw] max-sm:mx-auto max-sm:border' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d27972.283659901957!2d79.00423173526015!3d28.79311308041306!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390a8d3389e519a1%3A0x2678f83d0c9909c0!2sRaza%20Library!5e0!3m2!1sen!2sin!4v1745003892608!5m2!1sen!2sin" width="348" height="150" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
            <div className=''>
                        <div className='flex gap-5 mt-5 mb-5 max-sm:justify-center'>
                            <img className='w-[2vw]  max-sm:w-[10vw]' src="img/truck.png" alt="" />
                            <p className='mb-2 text-[var(--color-lightblack)]'>15 Days Return Policy*</p>
                        </div>
                        <div className='flex gap-5 mt-5 mb-5 max-sm:justify-center'>
                            <img className='w-[2vw] max-sm:w-[10vw]' src="img/payment.png" alt="" />
                            <p className='mb-2 text-[var(--color-lightblack)]'>Cash On Delivery*</p>
                        </div>
            </div>
            <div className=''>
                        <h1 className='text-2xl font-extrabold mb-5 max-sm:text-center'>DOWNLOAD THE APP</h1>
                        <div className='flex gap-2 mt-5 mb-5 max-sm:justify-center'>

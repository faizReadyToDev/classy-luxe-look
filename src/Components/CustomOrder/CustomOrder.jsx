...
function CustomOrder() {
  ...
  return (
    <>
        ...
        <form >
            <div className='w-[40vw] mx-auto mt-10 mb-20'>
               ...
               <div className='flex justify-between'>
                ...
                <div className='items-center flex justify-center p-4 gap-1'>
               ...
               <textarea className='border w-[39.5vw] rounded border-gray-400 px-4 pb-25' placeholder='Special Instructions' name="message" id="">
